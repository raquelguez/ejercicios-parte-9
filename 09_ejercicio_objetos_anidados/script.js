...
window.alert("¿Cómo te llamas?");
let nombre;
nombre = prompt("¿Cómo te llamas?");

let nombreBoard = randomObject.them.speed.past.program.grade.addition.whose.national.cannot.board;
console.log(nombreBoard);
nombreBoard.atributo = nombre; 
console.log(nombre);
